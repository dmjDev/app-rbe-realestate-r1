    ...
    <footer className="bgprimary txtprimary pb-12 mt-5">
      <div className="ancho-global">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-center mb-3 w-[80%]">
            Wishing you positive energy as you prepare for your big moment,
            because you have everything inside you to succeed beautifully...
            Choose your place.
          </p>
          <div className="mx-auto grid grid-cols-1 w-[80%]">
            <div className="flex flex-col items-center justify-center border-t border-dotted mt-5 pt-5">
              {session ? (
                ...
                <Link href="/auth" className="textbutton">
                  Go in
                </Link>
              )}
